...
const HeaderSliderMobileButton = ({ second = false }) => {
	...
	return !second ? (
		<div className='header__swt lll' onClick={onClickButtonHandler}>
			<svg
				width='20'
				height='20'
				viewBox='0 0 20 20'
		...
		<div className='header__swt111 lll' onClick={onClickSecondButtonHandler}>
			<svg
				width='24'
				height='16'
				viewBox='0 0 24 16'
...
export default HeaderSliderMobileButton;
